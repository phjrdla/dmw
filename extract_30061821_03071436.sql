...
spool fin_inst_op_data_180703.csv
...
from (SELECT financial_operation.policy_number,
          ...
          FROM financial_operation
               JOIN fin_inst_financial_operation ON (financial_operation.oid = fin_inst_financial_operation.financial_operation_oid 
                                                                                                       and financial_operation.creation_date_time > to_date('30/06/2018 18:21:00', 'dd/mm/yyyy HH24:MI:SS')
                                                                                                       and financial_operation.creation_date_time < to_date('03/07/2018 14:36:00', 'dd/mm/yyyy HH24:MI:SS')
                                                                                                       )
