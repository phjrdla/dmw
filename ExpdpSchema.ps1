...
Size in GB of dumpfile chunks. Possible values are 1G, 2G, 4G, 8G, 16G. Default is 4G.
...
[CmdletBinding()] param(
  ...
  [ValidateSet('1G','2G','4G','8G','16G')] [string]$dumpfileChunkSize = '4G',
...
write-host "    dumpfileChunkSize is $dumpfileChunkSize"
