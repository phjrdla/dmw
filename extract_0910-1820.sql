...
from (SELECT financial_operation.policy_number,
          ...
          FROM financial_operation
               JOIN fin_inst_financial_operation ON (financial_operation.oid = fin_inst_financial_operation.financial_operation_oid 
                                                                                                       and financial_operation.creation_date_time > to_date('30/06/2018 09:10:00', 'dd/mm/yyyy HH24:MI:SS')
                                                                                                       and financial_operation.creation_date_time < to_date('30/06/2018 18:20:00', 'dd/mm/yyyy HH24:MI:SS')
                                                                                                       )
